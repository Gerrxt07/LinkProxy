...
import com.linkpowered.proxy.scheduler.LinkScheduler.LinkTask;
...
class LinkSchedulerTest {
  ...
  void buildTask() throws Exception {
    ...
    LinkScheduler scheduler = new LinkScheduler(new FakePluginManager(), backend);
