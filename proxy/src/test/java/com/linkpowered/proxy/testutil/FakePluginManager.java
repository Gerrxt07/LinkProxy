...
package com.linkpowered.proxy.testutil;
...
public class FakePluginManager implements PluginManager {
  ...
  private final PluginContainer containerLink = new FakePluginContainer("link",
      LinkVirtualPlugin.INSTANCE);
  ...
  public @NonNull Optional<PluginContainer> fromInstance(@NonNull Object instance) {
    ...
    } else if (instance == LinkVirtualPlugin.INSTANCE) {
      return Optional.of(containerLink);
    } else {
  ...
  public @NonNull Optional<PluginContainer> getPlugin(@NonNull String id) {
    return switch (id) {
      ...
      case "link" -> Optional.of(containerLink);
  ...
  public @NonNull Collection<PluginContainer> getPlugins() {
    return ImmutableList.of(containerLink, containerA, containerB);
  }
