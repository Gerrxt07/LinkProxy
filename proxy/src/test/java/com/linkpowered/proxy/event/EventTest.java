...
import com.linkpowered.api.event.AwaitingEventExecutor;
...
import com.linkpowered.proxy.testutil.FakePluginManager;
...
public class EventTest {
  ...
  private final LinkEventManager eventManager = new LinkEventManager(pluginManager);
