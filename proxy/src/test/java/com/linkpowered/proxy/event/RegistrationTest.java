...
import static com.linkpowered.proxy.testutil.FakePluginManager.PLUGIN_A;
import static com.linkpowered.proxy.testutil.FakePluginManager.PLUGIN_B;
...
public class RegistrationTest {
  ...
  protected EventManager createEventManager(PluginManager pluginManager) {
    return new LinkEventManager(pluginManager);
  }
