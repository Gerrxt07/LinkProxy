...
package com.linkpowered.proxy.event;
...
import com.linkpowered.api.event.Continuation;
import com.linkpowered.api.event.EventHandler;
import com.linkpowered.api.event.EventManager;
import com.linkpowered.api.event.EventTask;
import com.linkpowered.api.event.PostOrder;
import com.linkpowered.api.event.Subscribe;
...
import com.linkpowered.proxy.event.UntargetedEventHandler.EventTaskHandler;
import com.linkpowered.proxy.event.UntargetedEventHandler.VoidHandler;
import com.linkpowered.proxy.event.UntargetedEventHandler.WithContinuationHandler;
import com.linkpowered.proxy.util.collect.Enum2IntMap;
...
/**
 * Implements the Link event handler.
 */
public class LinkEventManager implements EventManager {
  ...
  private static final Enum2IntMap<PostOrder> POST_ORDER_MAP = new Enum2IntMap.Builder<>(PostOrder.class)
      ...
      .build();
  private static final Logger logger = LogManager.getLogger(LinkEventManager.class);
  ...
  /**
   * Initializes the Link event manager.
   *
   * @param pluginManager a reference to the Link plugin manager
   */
  public LinkEventManager(final PluginManager pluginManager) {
