...
import static com.linkpowered.api.event.query.ProxyQueryEvent.QueryType.BASIC;
import static com.linkpowered.api.event.query.ProxyQueryEvent.QueryType.FULL;

import com.github.benmanes.caffeine.cache.Cache;
import com.github.benmanes.caffeine.cache.Caffeine;
import com.google.common.collect.ImmutableSet;
import com.linkpowered.api.event.query.ProxyQueryEvent;
...
import com.linkpowered.api.proxy.server.QueryResponse;
...
/**
 * Implements the GameSpy protocol for Link.
 */
public class GameSpyQueryHandler extends SimpleChannelInboundHandler<DatagramPacket> {
  ...
  public GameSpyQueryHandler(LinkServer server) {
    this.server = server;
