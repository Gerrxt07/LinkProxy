...
import static com.linkpowered.proxy.protocol.netty.MinecraftVarintLengthEncoder.IS_JAVA_CIPHER;

import com.linkpowered.natives.compression.LinkCompressor;
import com.linkpowered.natives.util.MoreByteBufUtils;
...
public class MinecraftCompressorAndLengthEncoder extends MessageToByteEncoder<ByteBuf> {
  ...
  public MinecraftCompressorAndLengthEncoder(int threshold, LinkCompressor compressor) {
