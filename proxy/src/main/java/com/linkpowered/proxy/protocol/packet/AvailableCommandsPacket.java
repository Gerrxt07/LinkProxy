...
import com.linkpowered.proxy.protocol.packet.brigadier.ArgumentPropertyRegistry;
import com.linkpowered.proxy.util.collect.IdentityHashStrategy;
...
public class AvailableCommandsPacket implements MinecraftPacket {
  ...
  public int encodeSizeHint(Direction direction, ProtocolVersion version) {
    // This is a very complex packet to encode. Paper 1.21.10 + Link with Spark has a size of
