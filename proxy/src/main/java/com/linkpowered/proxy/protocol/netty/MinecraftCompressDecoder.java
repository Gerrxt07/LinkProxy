...
import static com.linkpowered.natives.util.MoreByteBufUtils.ensureCompatible;
import static com.linkpowered.natives.util.MoreByteBufUtils.preferredBuffer;
import static com.linkpowered.proxy.protocol.util.NettyPreconditions.checkFrame;

import com.linkpowered.natives.compression.LinkCompressor;
import com.linkpowered.proxy.network.limiter.PacketLimiter;
...
public class MinecraftCompressDecoder extends MessageToMessageDecoder<ByteBuf> {
  ...
  private static final int CLIENTBOUND_UNCOMPRESSED_CAP =
      Boolean.getBoolean("link.increased-compression-cap")
  ...
  private static final boolean SKIP_COMPRESSION_VALIDATION = Boolean.getBoolean("link.skip-uncompressed-packet-size-validation");
  private final ProtocolUtils.Direction direction;

  private int threshold;
  private final LinkCompressor compressor;
  @Nullable
   ...
   */
  public MinecraftCompressDecoder(int threshold, LinkCompressor compressor, ProtocolUtils.Direction direction) {
