...
public class ResourcePackRequestPacket implements MinecraftPacket {
  ...
  public LinkResourcePackInfo toServerPromptedPack() {
    final ResourcePackInfo.Builder builder =
        new LinkResourcePackInfo.BuilderImpl(Preconditions.checkNotNull(url))
    ...
    return (LinkResourcePackInfo) builder.build();
  }
