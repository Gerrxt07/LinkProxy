...
package com.linkpowered.proxy.util.concurrent;
 ...
 */
public class LinkNettyThreadFactory implements ThreadFactory {

  private final AtomicInteger threadNumber = new AtomicInteger();
  private final String nameFormat;

  public LinkNettyThreadFactory(String nameFormat) {
