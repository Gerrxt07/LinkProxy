...
package com.linkpowered.proxy.command.registrar;

import com.google.common.base.Preconditions;
import com.linkpowered.api.command.CommandInvocation;
...
import com.linkpowered.proxy.command.LinkCommandMeta;
import com.linkpowered.proxy.command.LinkCommands;
import com.linkpowered.proxy.command.brigadier.LinkArgumentBuilder;
import com.linkpowered.proxy.command.brigadier.LinkBrigadierCommandWrapper;
import com.linkpowered.proxy.command.invocation.CommandInvocationFactory;
...
abstract class InvocableCommandRegistrar<T extends InvocableCommand<I>,
  ...
  private LiteralCommandNode<CommandSource> createLiteral(final T command, final CommandMeta meta,
    ...
    final Command<CommandSource> callback = LinkBrigadierCommandWrapper.wrap(context -> {
      final I invocation = invocationFactory.create(context);
    ...
    final ArgumentCommandNode<CommandSource, String> arguments = LinkArgumentBuilder
        .<CommandSource, A>linkArgument(LinkCommands.ARGS_NODE_NAME, argumentsType)
    ...
    // Add hinting nodes
    LinkCommandMeta.copyHints(meta).forEach(literal::addChild);
