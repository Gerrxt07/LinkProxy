 ...
 */
public class LinkArgumentCommandNode<S, T> extends ArgumentCommandNode<S, String> {

  private final ArgumentType<T> type;

  LinkArgumentCommandNode(
  ...
  public LinkArgumentCommandNode<S, T> withCommand(Command<S> command) {
    return new LinkArgumentCommandNode<>(getName(), type, command, getRequirement(),
        getContextRequirement(), getRedirect(), getRedirectModifier(), isFork(), getCustomSuggestions());
  }

  public LinkArgumentCommandNode<S, T> withRedirect(CommandNode<S> target) {
    return new LinkArgumentCommandNode<>(getName(), type, getCommand(), getRequirement(),
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof LinkArgumentCommandNode that)) {
      return false;
    }
