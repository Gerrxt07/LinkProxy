...
/**
 * Implements the Link default {@code /send} command.
 */
public class SendCommand {
  ...
  public void register() {
    final LiteralArgumentBuilder<CommandSource> rootNode = BrigadierCommand
        ...
        .requires(source ->
            source.getPermissionValue("link.command.send") == Tristate.TRUE)
        .executes(this::usage);
  ...
  private int usage(final CommandContext<CommandSource> context) {
    context.getSource().sendMessage(
        Component.translatable("link.command.send-usage", NamedTextColor.YELLOW)
    );
