 ...
 */
public final class LinkCommandMeta implements CommandMeta {
  ...
  static final class Builder implements CommandMeta.Builder {
    ...
    public CommandMeta build() {
      return new LinkCommandMeta(this.aliases.build(), this.hints.build(), this.plugin);
    }
  }
  ...
  public static Stream<CommandNode<CommandSource>> copyHints(final CommandMeta meta) {
    return meta.getHints().stream().map(LinkCommandMeta::copyForHinting);
  }
  ...
  public boolean equals(final Object o) {
    ...
    final LinkCommandMeta that = (LinkCommandMeta) o;
