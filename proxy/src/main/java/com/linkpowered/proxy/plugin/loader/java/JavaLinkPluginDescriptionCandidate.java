...
class JavaLinkPluginDescriptionCandidate extends LinkPluginDescription {

  private final String mainClass;

  JavaLinkPluginDescriptionCandidate(String id, @Nullable String name, @Nullable String version,
