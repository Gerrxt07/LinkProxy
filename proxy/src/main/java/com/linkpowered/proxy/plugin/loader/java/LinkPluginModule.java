...
import com.linkpowered.api.plugin.annotation.DataDirectory;
...
class LinkPluginModule implements Module {

  private final JavaLinkPluginDescription description;
  private final PluginContainer pluginContainer;
  private final Path basePluginPath;

  LinkPluginModule(JavaLinkPluginDescription description, PluginContainer pluginContainer,
      Path basePluginPath) {
