 ...
 */
public class LinkPluginDescription implements PluginDescription {
   ...
   */
  public LinkPluginDescription(String id, @Nullable String name, @Nullable String version,
