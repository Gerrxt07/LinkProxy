...
package com.linkpowered.proxy.connection.forge.modern;

import static com.linkpowered.proxy.connection.forge.modern.ModernForgeConstants.MODERN_FORGE_TOKEN;

import com.linkpowered.proxy.connection.backend.BackendConnectionPhases;
import com.linkpowered.proxy.connection.client.ClientConnectionPhases;
import com.linkpowered.proxy.connection.util.ConnectionTypeImpl;
