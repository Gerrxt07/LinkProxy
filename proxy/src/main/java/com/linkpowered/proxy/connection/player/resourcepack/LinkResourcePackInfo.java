...
package com.linkpowered.proxy.connection.player.resourcepack;
 ...
 */
public final class LinkResourcePackInfo implements ResourcePackInfo {
  ...
  private LinkResourcePackInfo(UUID id, String url, byte @Nullable [] hash, boolean shouldForce,
  ...
  public static final class BuilderImpl implements ResourcePackInfo.Builder {
    ...
    public ResourcePackInfo build() {
      return new LinkResourcePackInfo(id, url, hash, shouldForce, prompt, origin);
    }
