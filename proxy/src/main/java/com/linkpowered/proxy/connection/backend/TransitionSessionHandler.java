...
import static com.linkpowered.proxy.connection.backend.BackendConnectionPhases.IN_TRANSITION;
import static com.linkpowered.proxy.connection.forge.legacy.LegacyForgeHandshakeBackendPhase.HELLO;

import com.linkpowered.api.event.player.ServerConnectedEvent;
...
public class TransitionSessionHandler implements MinecraftSessionHandler {
   ...
   */
  TransitionSessionHandler(LinkServer server,
  ...
  public boolean handle(PluginMessagePacket packet) {
    ...
    if (serverConn.getPhase().handle(serverConn, serverConn.getPlayer(), packet)) {
      ...
      if (serverConn.getPhase() == HELLO) {
        LinkServerConnection existingConnection = serverConn.getPlayer().getConnectedServer();
