...
package com.linkpowered.proxy.adventure;
...
public final class LinkBossBarImplementation implements BossBar.Listener,
  ...
  public static LinkBossBarImplementation get(final BossBar bar) {
    return BossBarImplementation.get(bar, LinkBossBarImplementation.class);
  }

  LinkBossBarImplementation(final BossBar bar) {
    this.bar = bar;
  }
