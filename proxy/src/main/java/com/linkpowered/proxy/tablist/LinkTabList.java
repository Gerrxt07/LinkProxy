 ...
 */
public class LinkTabList implements InternalTabList {

  private static final Logger logger = LogManager.getLogger(LinkConsole.class);
  private final ConnectedPlayer player;
  private final MinecraftConnection connection;
  private final Map<UUID, LinkTabListEntry> entries;
   ...
   */
  public LinkTabList(ConnectedPlayer player) {
    this.player = player;
  ...
  public void addEntry(TabListEntry entry1) {
    LinkTabListEntry entry;
    if (entry1 instanceof LinkTabListEntry) {
      entry = (LinkTabListEntry) entry1;
    } else {
      entry = new LinkTabListEntry(this, entry1.getProfile(),
  ...
  public TabListEntry buildEntry(GameProfile profile, @Nullable Component displayName, int latency,
    ...
    return new LinkTabListEntry(this, profile, displayName, latency, gameMode, chatSession,
  ...
  protected UpsertPlayerInfoPacket.Entry createRawEntry(LinkTabListEntry entry) {
