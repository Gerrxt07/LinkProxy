 ...
 */
public class KeyedLinkTabListEntry implements TabListEntry {

  private final KeyedLinkTabList tabList;
  ...
  KeyedLinkTabListEntry(KeyedLinkTabList tabList, GameProfile profile,
