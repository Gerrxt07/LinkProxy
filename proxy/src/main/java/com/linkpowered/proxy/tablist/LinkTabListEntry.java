...
import com.linkpowered.api.proxy.player.TabList;
 ...
 */
public class LinkTabListEntry implements TabListEntry {

  private final LinkTabList tabList;
   ...
   */
  public LinkTabListEntry(LinkTabList tabList, GameProfile profile, Component displayName,
                              int latency,
  ...
  @Override
  public LinkTabListEntry setListed(boolean listed) {
    this.listed = listed;
    UpsertPlayerInfoPacket.Entry upsertEntry = this.tabList.createRawEntry(this);
  ...
  @Override
  public LinkTabListEntry setListOrder(int listOrder) {
    this.listOrder = listOrder;
  ...
  @Override
  public LinkTabListEntry setShowHat(boolean showHat) {
    this.showHat = showHat;
