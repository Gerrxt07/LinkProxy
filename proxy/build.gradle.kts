...
tasks {
    ...
    jar {
        manifest {
            attributes["Implementation-Title"] = "Link"
            attributes["Implementation-Vendor"] = "Link Contributors"
...
dependencies {
    ...
    implementation(project(":link-native"))
