...
Java_com_linkpowered_natives_compression_NativeZlibInflate_init(JNIEnv *env,
    jclass clazz)
{
...
Java_com_linkpowered_natives_compression_NativeZlibInflate_free(JNIEnv *env,
    jclass clazz,
    jlong ctx)
{
...
Java_com_linkpowered_natives_compression_NativeZlibInflate_process(JNIEnv *env,
    jclass clazz,
    jlong ctx,
    jlong sourceAddress,
    jint sourceLength,
