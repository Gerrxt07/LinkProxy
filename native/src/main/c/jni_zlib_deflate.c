...
Java_com_linkpowered_natives_compression_NativeZlibDeflate_init(JNIEnv *env,
    jclass clazz,
    jint level)
{
...
Java_com_linkpowered_natives_compression_NativeZlibDeflate_free(JNIEnv *env,
    jclass clazz,
    jlong ctx)
{
...
JNIEXPORT jlong JNICALL
Java_com_linkpowered_natives_compression_NativeZlibDeflate_process(JNIEnv *env,
    jclass clazz,
    jlong ctx,
    jlong sourceAddress,
    jint sourceLength,
