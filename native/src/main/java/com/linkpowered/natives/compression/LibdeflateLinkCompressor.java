 ...
 */
public class LibdeflateLinkCompressor implements LinkCompressor {

  public static final LinkCompressorFactory FACTORY = LibdeflateLinkCompressor::new;

  private final long inflateCtx;
  private final long deflateCtx;
  private boolean disposed = false;

  private LibdeflateLinkCompressor(int level) {
