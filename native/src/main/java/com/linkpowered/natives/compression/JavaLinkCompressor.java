...
import static com.linkpowered.natives.compression.CompressorUtils.ZLIB_BUFFER_SIZE;
 ...
 */
public class JavaLinkCompressor implements LinkCompressor {

  public static final LinkCompressorFactory FACTORY = JavaLinkCompressor::new;

  private final Deflater deflater;
  private final Inflater inflater;
  private boolean disposed = false;

  private JavaLinkCompressor(int level) {
