...
import com.linkpowered.api.event.ResultedEvent;
import com.linkpowered.api.event.annotation.AwaitingEvent;
import com.linkpowered.api.event.command.CommandExecuteEvent.CommandResult;
import java.util.Optional;
import org.checkerframework.checker.nullness.qual.NonNull;
import org.checkerframework.checker.nullness.qual.Nullable;

/**
 * This event is fired when someone executes a command. Link will wait for this event to finish
...
public final class CommandExecuteEvent implements ResultedEvent<CommandResult> {
   ...
   *          but still be validly executed. For example, the command {@code /  link info},
   *          although not valid in the chat bar, will be executed as correctly as if
   *          the player had executed {@code /link info}
   */
  ...
  public static final class CommandResult implements ResultedEvent.Result {
     ...
     * default behavior when a command is not registered on Link.
     *
