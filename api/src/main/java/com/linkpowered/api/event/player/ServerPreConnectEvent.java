...
import com.linkpowered.api.proxy.ConnectionRequestBuilder.Status;
...
/**
 * This event is fired before the player connects to a server. Link will wait on this event to
