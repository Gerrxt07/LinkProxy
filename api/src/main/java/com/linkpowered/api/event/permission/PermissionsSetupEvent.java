...
package com.linkpowered.api.event.permission;
...
import com.linkpowered.api.permission.PermissionSubject;
import org.checkerframework.checker.nullness.qual.Nullable;

/**
 * Called when a {@link PermissionSubject}'s permissions are being setup. This event is typically
 * called for the {@link com.linkpowered.api.proxy.ConsoleCommandSource} and any
 * {@link com.linkpowered.api.proxy.Player}s who join the proxy.
 *
 * <p>This event is only called once per subject, on initialisation.</p>
 *
 * <p>
 *   Link will wait for this event to finish firing before proceeding further with server
