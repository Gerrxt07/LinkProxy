...
package com.linkpowered.api.event;
 ...
 * asynchronously.
 *
 * <p><strong>Compatibility notice:</strong> While in Link 3.0.0, all event handlers still
 * execute asynchronously (to preserve backwards compatibility), this will not be the case in future
 * versions of Link. Please prepare your code by using continuations or returning an instance
