...
import com.linkpowered.api.event.player.ServerLoginPluginMessageEvent.ResponseResult;
 ...
 * respond to the messages as needed. Link will wait on this event to finish. The server will
