 ...
 *
 * @implNote Link will wait for all event listeners to complete before disconnecting players,
 *     but note that the event will time out after the configured value of the
 *     <code>link.pre-shutdown-timeout</code> system property, default 10 seconds,
