...
import com.linkpowered.api.proxy.InboundConnection;
 ...
 * (for offline mode). Link will wait for this event to finish firing before proceeding further
 * with the login process, but you should try to limit the work done in any event that fires during
 * the login process.
 *
 * <p>
 *   As of Link 3.1.0, you may cast the {@link InboundConnection} to a
 *   {@link com.linkpowered.api.proxy.LoginPhaseConnection} to allow a
