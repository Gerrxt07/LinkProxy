...
package com.linkpowered.api.proxy.config;
...
public interface ProxyConfig {
  ...
  /**
   * Whether GameSpy 4 queries should show plugins installed on Link by default.
   *
  ...
  /**
   * Get a Map of all servers registered in <code>link.toml</code>. This method does
