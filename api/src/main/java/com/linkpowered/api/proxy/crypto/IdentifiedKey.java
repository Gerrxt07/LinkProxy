...
package com.linkpowered.api.proxy.crypto;

import com.google.common.collect.ImmutableSet;
import com.linkpowered.api.network.ProtocolVersion;
import com.linkpowered.api.util.Ordered;
...
public interface IdentifiedKey extends KeySigned {
   ...
   * Returns null before the {@link com.linkpowered.api.event.connection.LoginEvent}.
   *
