...
public interface ConnectionRequestBuilder {
  ...
  /**
   * Initiates the connection to the remote server and emits a result on the {@link
   * CompletableFuture} after the user has logged on. Link's own built-in handling will be used
  ...
  /**
   * Initiates the connection to the remote server without waiting for a result. Link will use
